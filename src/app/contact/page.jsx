...
const Contact = () => {
  return (
    <div>
      <div>
        <p className="px-3 md:px-16 py-20 font-black text-[35px] text-white md:text-[60px] background-image">
          Contact
        </p>
      </div>
            ...
            <div className="flex-1 rounded-br-lg border-r-2 border-b-2 border-red-600">
              <div className="my-5">
                ...
                <div className="flex flex-col gap-5">
                  <p>
                    For all Investor & Vendor Relations enquiries please <br />
          ...
          <div className="flex flex-col md:flex-row gap-10 md:gap-20 md:px-20 mt-24">
            ...
            <div className="flex-1 rounded-br-lg border-r-2 border-b-2 border-red-600">
              <div className="my-5">
                ...
                <div className="flex flex-col gap-5">
                  <p>
                    For all media adn Hilltop's Cyber-Information enquiries
