...
const Driven = () => {
  return (
    <div className="bg-red-700 w-full h-max flex flex-col justify-center items-center text-white py-16 px-1 md:px-5 gap-5">
      <div className="bg-black flex flex-col gap-5 md:flex-row items-center ">
